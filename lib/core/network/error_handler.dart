...
Failure _handleError(DioException error) {
  ...
  if(error.response?.data != null) {
    errorMessage = error.response?.data is Map? error.response?.data["message"] : null;
  ...
  Failure getFailure({String? message}) {
    switch (this) {
      ...
      case ResponseTypes.CONNECT_TIMEOUT:
        return Failure(
            ResponseCode.CONNECT_TIMEOUT, message ?? ResponseMessage.CONNECT_TIMEOUT);
      ...
      case ResponseTypes.RECEIVE_TIMEOUT:
        return Failure(
            ResponseCode.RECEIVE_TIMEOUT, message ?? ResponseMessage.RECEIVE_TIMEOUT);
...
class ResponseMessage {
  ...
  static const String UNKNOWN = AppStrings.defaultError;
}
